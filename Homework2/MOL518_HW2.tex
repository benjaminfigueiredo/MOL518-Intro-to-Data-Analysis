...
In the \texttt{images} folder there are 20 microscopy \texttt{.tif} files. {\it Do not use AI to generate code for this problem. This problem has some things we only touched on, you may use AI to help solve the problem but make sure to follow the guidelines in the syllabus.}
